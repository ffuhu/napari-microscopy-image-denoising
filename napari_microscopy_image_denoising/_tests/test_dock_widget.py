import napari_microscopy_image_denoising
import pytest

# this is your plugin name declared in your napari.plugins entry point
MY_PLUGIN_NAME = "napari-microscopy-image-denoising"
...
def test_something_with_viewer(widget_name, make_napari_viewer, napari_plugin_manager):
    napari_plugin_manager.register(napari_microscopy_image_denoising, name=MY_PLUGIN_NAME)
